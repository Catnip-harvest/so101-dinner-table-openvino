...
DATASET      = "VietHwang/dinner-table-v2"        # physics dataset
PROBE        = "VietHwang/dinner-table-probe"     # 5-episode probe, if it lands first
POLICY_REPO  = "VietHwang/smolvla-dinner-table"
BUDGET_H     = 11.0     # Kaggle cuts the session at 12 h; leave headroom
